 ...
 */
public class CustomerDetailsMapper implements ResultSetMapper<Customer> {
    @Override
    public Customer map(int i, ResultSet resultSet, StatementContext statementContext) throws SQLException {
        return new Customer(resultSet.getString("customer_name"), resultSet.getString("customer_phone"));
    }
}
